...
import in.amigoscorp.samiksha.utils.DisplayNotification;

/**
 * Created by sriny on 23/02/17.
 */

public class SamikshaFirebaseMessagingService extends FirebaseMessagingService {

    private static final String TAG = "SamikshaFMService";
    ...
    private void sendNotification(String messageBody) {
        int notificationCount = CommonUtils.readFromSharedPreferences(getApplicationContext(), R.string.notification_count);
        ...
        notificationCount++;
        CommonUtils.writeToSharedPreferences(getApplicationContext(), R.string.notification_count, notificationCount);
    }
